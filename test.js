...
TrilateralFill.__super__ = trilateralBasic_AppGL;
TrilateralFill.prototype = $extend(trilateralBasic_AppGL.prototype,{
	draw: function(pen) {
...
function TrilateralFill_main() {
	...
	haxe_Log.trace("TrilateralFill example",{ fileName : "TrilateralFill.hx", lineNumber : 24, className : "_TrilateralFill.TrilateralFill_Statics_", methodName : "main"});
}
